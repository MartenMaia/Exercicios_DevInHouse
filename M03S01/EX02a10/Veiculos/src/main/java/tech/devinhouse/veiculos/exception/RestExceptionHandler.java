...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(VeiculoComMultaAtiva.class)
    public ResponseEntity<Object> handleVeiculoComMultaAtiva(VeiculoComMultaAtiva e) {
        Map<String, String> retorno = new HashMap<>();
        retorno.put("erro", "Delete impossivel! Veiculo com Multa ativa!");
